...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gstlal-inspiral-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gstlal-inspiral-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gstlal-inspiral
# for installing globally
pixi global install gstlal-inspiral
```
...
It is possible to list all of the versions of `gstlal-inspiral` available on your platform:
...
```
pixi search gstlal-inspiral --channel conda-forge
```
